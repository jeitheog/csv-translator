...
def _call_gemini(title, description, vendor):
    ...
    prompt = (
        ...
        '- "tag": SOLO el tipo de artículo en español, una palabra o frase muy corta (máximo 3 palabras), '
        'sin adjetivos, colores ni materiales. '
        'Ejemplos: "Sofá", "Silla", "Mesa de comedor", "Bolso", "Zapatillas", "Chaqueta", "Camiseta", "Armario".\n\n'
        '- "title": título con el formato EXACTO: "[Nombre del producto] - [algo llamativo]"\n'
        '  * "[Nombre del producto]" = exactamente lo mismo que el "tag" (qué es el artículo)\n'
        '  * " - " = guion con espacios\n'
        '  * "[algo llamativo]" = característica más atractiva del producto: material, estilo, color especial o detalle único. '
        'Máximo 5 palabras. Sin el nombre de la marca.\n'
        '  Ejemplos válidos:\n'
        '  "Sofá - Chester de Terciopelo Azul Marino"\n'
        '  "Zapatillas - Running de Cuero Premium"\n'
        '  "Bolso - Piel Genuina Camel con Cadena"\n'
        '  "Chaqueta - Lana Merino de Corte Slim"\n\n'
